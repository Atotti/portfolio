...
result.innerHTML = "配列がソートされました。この配列はどのアルゴリズムによってソートされましたか？" + "<li><button onclick=\"checkAnswer('Bubble Sort')\">Bubble Sort</button></li>\n    <li><button onclick=\"checkAnswer('Quick Sort')\">Quick Sort</button></li>\n    <li><button onclick=\"checkAnswer('Insertion Sort')\">Insertion Sort</button></li>\n    <li><button onclick=\"checkAnswer('Merge Sort')\">Merge Sort</button></li>\n";
}
